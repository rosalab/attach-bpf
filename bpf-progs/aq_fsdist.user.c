...
int main()
{
    ...
    bpf_program__set_color(p_read_fentry, 0x1, 0x1);
    bpf_program__set_color(p_write_fentry, 0x1, 0x1);
    bpf_program__set_color(p_open_fentry, 0x1, 0x1);
    bpf_program__set_color(p_sync_fentry, 0x1, 0x1);
    bpf_program__set_color(p_getattr_fentry, 0x1, 0x1);
    bpf_program__set_color(p_read_fexit, 0x1, 0x1);
    bpf_program__set_color(p_write_fexit, 0x1, 0x1);
    bpf_program__set_color(p_open_fexit, 0x1, 0x1);
    bpf_program__set_color(p_sync_fexit, 0x1, 0x1);
    bpf_program__set_color(p_getattr_fexit, 0x1, 0x1);
